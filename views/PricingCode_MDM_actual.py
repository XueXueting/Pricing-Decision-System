...
# ### Function 1： fun_true_pricing_MIP(vc, sample_ind100, cost)
# 
...
Pptimalprice_MDMprice, Profit_MDM_price, Duration_mdm_price, Point, Demand, Index = fun_PriceError_max_mainMDM(p_subsets_aggr,x_subsets_aggr,vc,Cost)
...
MDM_opt_price, MDM_opt_profit_estimated = optimization_MIP_pulp(MNL_Cost, MNL_Share_mat_purturbed, MNL_Point_purturbed, MNL_idx_purturbed)[2:4]
...
GM_salesDataFrame =  pd.read_csv('../data/GM_salesdata.csv',na_filter=False) 
GM_salesData = GM_salesDataFrame.values
GM_BaseDataFrame =  pd.read_csv('../data/GM_baseData.csv',na_filter=False)
...
optx, optdelta, MDM_price, MDM_profit_estimated = optimization_MIP_pulp_GM(cost,demand,point,index,baseprice)
